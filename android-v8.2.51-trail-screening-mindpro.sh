...
# Reuse the verified V8.2.50 native stack unchanged, including MindPro native voice bridge.
bash "$GITHUB_WORKSPACE/android-v8.2.50-mindpro-native-voice.sh"
...
sed -i "s/versionCode 870/versionCode 871/; s/versionName '8.2.50'/versionName '8.2.51'/" "$GRADLE"
...
echo 'V8.2.51 version-only rebuild from verified V8.2.50 native stack: PASS'
