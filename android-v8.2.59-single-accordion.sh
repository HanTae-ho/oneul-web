...
# Reuse the verified V8.2.58 native stack unchanged.
bash "$GITHUB_WORKSPACE/android-v8.2.58-privacy-concise.sh"
...
grep -q "versionCode 878" "$GRADLE"
grep -q "versionName '8.2.58'" "$GRADLE"
sed -i "s/versionCode 878/versionCode 879/; s/versionName '8.2.58'/versionName '8.2.59'/" "$GRADLE"
...
echo 'V8.2.59 version-only rebuild from verified V8.2.58 native stack: PASS'
