...
# Context-aware back labels/fallbacks.
...
# Draw function placed immediately before HOV implementation.
marker="""/* ══════════ SMART Recovery · HOV V8.2.5 ══════════ */\nfunction smartHovValues"""
...
s=replace_once(s,marker,fn,'importance draw function')

# Learning action routing.
