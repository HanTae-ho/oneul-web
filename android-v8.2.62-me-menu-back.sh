...
# Reuse the verified V8.2.61 native stack unchanged.
bash "$GITHUB_WORKSPACE/android-v8.2.61-onboarding-ai-setting.sh"
...
grep -q "versionCode 881" "$GRADLE"
grep -q "versionName '8.2.61'" "$GRADLE"
sed -i "s/versionCode 881/versionCode 882/; s/versionName '8.2.61'/versionName '8.2.62'/" "$GRADLE"
...
echo 'V8.2.62 version-only rebuild from verified V8.2.61 native stack: PASS'
