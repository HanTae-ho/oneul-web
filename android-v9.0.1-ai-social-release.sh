...
# V9.0.1 documentation-sync rebuild. Keep the V9.0 / physically verified V8.5
# native reminder/TTS stack unchanged; only Android package metadata advances.
...
sed -i "s/versionCode 893/versionCode 895/; s/versionName '9.0'/versionName '9.0.1'/" "$GRADLE"

grep -q "versionCode 895" "$GRADLE"
...
echo 'V9.0.1 Android docs-sync release patch PASS'
