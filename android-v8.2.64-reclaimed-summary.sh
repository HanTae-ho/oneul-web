...
# Reuse the verified V8.2.63 native stack unchanged.
bash "$GITHUB_WORKSPACE/android-v8.2.63-admin-render-fix.sh"
...
sed -i "s/versionCode 883/versionCode 884/; s/versionName '8.2.63'/versionName '8.2.64'/" "$GRADLE"
...
echo 'V8.2.64 version-only rebuild from verified V8.2.63 native stack: PASS'
