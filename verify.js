...
ok(/id="social-leave-confirm"/.test(index)&&!/social-leave-next/.test(index)&&!/social-leave-word/.test(index),'소셜 탈퇴 1회 확인 후 바로 처리');
