...
# Reuse the verified V8.2.57 native stack unchanged.
bash "$GITHUB_WORKSPACE/android-v8.2.57-privacy-policy.sh"
...
sed -i "s/versionCode 877/versionCode 878/; s/versionName '8.2.57'/versionName '8.2.58'/" "$GRADLE"
...
echo 'V8.2.58 version-only rebuild from verified V8.2.57 native stack: PASS'
