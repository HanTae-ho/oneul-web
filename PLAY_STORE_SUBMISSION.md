# 오늘 한 걸음 V9.1.4 — Google Play 제출 준비서
...
- AAB: `oneul-v9.1.4.aab`
  - SHA-256: 정식 릴리스의 `SHA256SUMS.txt` 기준
- APK: `oneul-v9.1.4.apk`
  - SHA-256: 정식 릴리스의 `SHA256SUMS.txt` 기준
- V9.1.3 실제 Android 기기 설치·동작 확인: 완료
- V9.1.4 실기기 확인: 릴리스 후 별도 확인
...
현재 GitHub에서 직접 배포한 APK에는 기존 앱 서명키가 사용되고 있으며, V9.1.4 릴리스 과정에서도 V9.1.3과 서명 연속성을 검증하도록 고정합니다.
...
- 기존 직접설치 V9.1.4에서 Play 설치본으로 업데이트 가능 여부(서명 연속성)
...
- V9.1.4 실기기 설치·알림·TTS 동작 확인(릴리스 후)
