...
# Reuse the verified V8.2.65 native stack unchanged.
bash "$GITHUB_WORKSPACE/android-v8.2.65-reclaim-to-my.sh"
...
sed -i "s/versionCode 885/versionCode 886/; s/versionName '8.2.65'/versionName '8.2.66'/" "$GRADLE"
...
echo 'V8.2.66 version-only rebuild from verified V8.2.65 native stack: PASS'
