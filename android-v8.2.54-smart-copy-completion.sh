...
# Reuse the verified V8.2.53 native stack unchanged.
bash "$GITHUB_WORKSPACE/android-v8.2.53-generic-tool-names.sh"
...
sed -i "s/versionCode 873/versionCode 874/; s/versionName '8.2.53'/versionName '8.2.54'/" "$GRADLE"
...
echo 'V8.2.54 version-only rebuild from verified V8.2.53 native stack: PASS'
