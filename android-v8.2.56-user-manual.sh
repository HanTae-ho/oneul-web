...
# Reuse the verified V8.2.55 native stack unchanged.
bash "$GITHUB_WORKSPACE/android-v8.2.55-help-faq.sh"
...
sed -i "s/versionCode 875/versionCode 876/; s/versionName '8.2.55'/versionName '8.2.56'/" "$GRADLE"
...
echo 'V8.2.56 version-only rebuild from verified V8.2.55 native stack: PASS'
