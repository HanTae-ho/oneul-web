...
# Reuse the verified V8.2.60 native stack unchanged.
bash "$GITHUB_WORKSPACE/android-v8.2.60-mindpro-ai-consent.sh"
...
sed -i "s/versionCode 880/versionCode 881/; s/versionName '8.2.60'/versionName '8.2.61'/" "$GRADLE"
...
echo 'V8.2.61 version-only rebuild from verified V8.2.60 native stack: PASS'
